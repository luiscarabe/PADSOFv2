...
public class MQResolvedPanel extends JPanel {
	...
	public MQResolvedPanel(String nameStud, String nameExer, String nameQues, float wei, ArrayList<String> options, ArrayList<String> solution){
	...
	public MQResolvedPanel(String nameStud, String nameExer, String nameQues, float wei, ArrayList<String> options, ArrayList<String> solution, boolean correct){
