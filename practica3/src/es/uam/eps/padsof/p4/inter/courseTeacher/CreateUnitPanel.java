...
public class CreateUnitPanel extends JPanel{
	//Superior Panel
	...
	private JLabel creatLabel = new JLabel("Create Unit");
	private JLabel professor = new JLabel("Professor");
	private JButton signOut = new JButton("Sign out");
	private SpringLayout layout = new SpringLayout();
	
	private JLabel nameLabel = new JLabel("Write the name of the unit:");
	private JLabel descLabel = new JLabel("Write the description of the unit:");
	...
	/**
	 * Constructor of CreateUnitPanel
	 */
	
	public CreateUnitPanel(){
