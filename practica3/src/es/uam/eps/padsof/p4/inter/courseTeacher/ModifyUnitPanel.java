...
public class ModifyUnitPanel extends JPanel {
	//Superior Panel
	...
	private JLabel creatLabel = new JLabel("Modify Unit");
	private JLabel professor = new JLabel("Professor");
	private JButton signOut = new JButton("Sign out");
	private SpringLayout layout = new SpringLayout();
	
	private JLabel nameLabel = new JLabel("Modify the name of the unit:");
	private JLabel descLabel = new JLabel("Modify the description of the unit:");
	...
	/**
	 * Constructor of ModifyUnitPanel
	 * @param name
	 * @param desc
	 */
	public ModifyUnitPanel(String name, String desc){
