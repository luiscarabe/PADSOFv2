...
public class TakeUQExercisePanel extends JPanel{
		...
		private ArrayList<JRadioButton> listButtons = new ArrayList<JRadioButton>(); 
		...
		/**
		 * Constructor of TakeUQExercisePanel
		 * @param nameStud
		 * @param nameExer
		 * @param nameQues
		 * @param wei
		 * @param options
		 */
		public TakeUQExercisePanel(String nameStud, String nameExer, String nameQues, float wei, ArrayList<String> options){
		 ...
		 */
		public ArrayList<JRadioButton> getListButtons() {
			return listButtons;
		}
