...
public class AddQuestionTFPanel extends JPanel{
	...
	public AddQuestionTFPanel(){
		...
		layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, this.firstLabel, 0, SpringLayout.HORIZONTAL_CENTER, this);
		layout.putConstraint(SpringLayout.NORTH, this.firstLabel, 10, SpringLayout.NORTH, this);
		...
		layout.putConstraint(SpringLayout.WEST, this.solutionLabel, 10, SpringLayout.WEST, this);
		...
		layout.putConstraint(SpringLayout.WEST, this.create, 150, SpringLayout.WEST, this);
		...
		this.jd.setSize(new Dimension(500,300));
	}
}
