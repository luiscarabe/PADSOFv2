...
public class ModifyQuestionOTPanelController implements ActionListener{
	...
	private ModifyQuestionOTPanel view;
	...
	public ModifyQuestionOTPanelController(ModifyQuestionOTPanel view, Course course, List<Question> questions, boolean eqValue, Question question) {
		this.view = view;
		this.course = course;
